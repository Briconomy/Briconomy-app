...
const invoices = db.invoices.insertMany([
  // Emma Thompson invoices (Lease 1, 12500/month)
  {
    ...
    month: '6',
    year: 2024,
    markdownContent: '# Invoice INV-2024-06\n\n**Tenant:** Emma Thompson\n**Property:** Blue Hills Apartments\n**Unit:** 2A\n**Rent Amount:** R12,500.00\n**Due Date:** 2024-06-15',
    artifactPaths: { markdown: '/artifacts/inv-2024-06.md', pdf: '/artifacts/inv-2024-06.pdf' },
  ...
  },
  {
    ...
    month: '7',
    year: 2024,
    markdownContent: '# Invoice INV-2024-07\n\n**Tenant:** Emma Thompson\n**Property:** Blue Hills Apartments\n**Unit:** 2A\n**Rent Amount:** R12,500.00\n**Due Date:** 2024-07-15',
    artifactPaths: { markdown: '/artifacts/inv-2024-07.md', pdf: '/artifacts/inv-2024-07.pdf' },
  ...
  },
  {
    ...
    month: '8',
    year: 2024,
    markdownContent: '# Invoice INV-2024-08\n\n**Tenant:** Emma Thompson\n**Property:** Blue Hills Apartments\n**Unit:** 2A\n**Rent Amount:** R12,500.00\n**Due Date:** 2024-08-15',
    artifactPaths: { markdown: '/artifacts/inv-2024-08.md', pdf: '/artifacts/inv-2024-08.pdf' },
  ...
  // James Smith invoices (Lease 2, 15000/month)
  {
    ...
    month: '6',
    year: 2024,
    markdownContent: '# Invoice INV-2024-06-02\n\n**Tenant:** James Smith\n**Property:** Blue Hills Apartments\n**Unit:** 3C\n**Rent Amount:** R15,000.00\n**Due Date:** 2024-06-15',
    artifactPaths: { markdown: '/artifacts/inv-2024-06-02.md', pdf: '/artifacts/inv-2024-06-02.pdf' },
    createdAt: new Date('2024-06-01'),
    updatedAt: new Date('2024-06-01')
  },
  {
    ...
    month: '7',
    year: 2024,
    markdownContent: '# Invoice INV-2024-07-02\n\n**Tenant:** James Smith\n**Property:** Blue Hills Apartments\n**Unit:** 3C\n**Rent Amount:** R15,000.00\n**Due Date:** 2024-07-15 ⚠️ OVERDUE',
    artifactPaths: { markdown: '/artifacts/inv-2024-07-02.md', pdf: '/artifacts/inv-2024-07-02.pdf' },
    createdAt: new Date('2024-07-01'),
    updatedAt: new Date('2024-07-01')
  },
  {
    ...
    month: '8',
    year: 2024,
    markdownContent: '# Invoice INV-2024-08-02\n\n**Tenant:** James Smith\n**Property:** Blue Hills Apartments\n**Unit:** 3C\n**Rent Amount:** R15,000.00\n**Due Date:** 2024-08-15',
    artifactPaths: { markdown: '/artifacts/inv-2024-08-02.md', pdf: '/artifacts/inv-2024-08-02.pdf' },
    createdAt: new Date('2024-08-01'),
    updatedAt: new Date('2024-08-01')
  },

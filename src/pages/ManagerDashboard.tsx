...
function ManagerDashboard() {
  ...
  const varsityCollegeSandton = useMemo(() => [{
    id: 'varsity-college-sandton',
    name: 'Varsity College Sandton',
    address: 'Varsity College Sandton, 2 Sandton Dr, Sandton, Johannesburg, 2196',
    coordinates: [28.046546, -26.107836] as [number, number]
  }], []);
    ...
    <div className="app-container mobile-only">
      ...
      <div className="main-content">
        ...
        <ChartCard title={t('manager.property_locations')}>
          <PropertyMap locations={varsityCollegeSandton} />
        </ChartCard>

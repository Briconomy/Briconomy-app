...
const translations: Translations = {
  ...
  'prospect.map_view': { en: 'Map view', zu: 'Ukubuka imephu' },
  'prospect.map_section_subtitle': { en: 'Explore properties using live locations', zu: 'Hlola izindawo usebenzisa izindawo zangempela' },
  'prospect.map_loading': { en: 'Loading map...', zu: 'Kulayishwa imephu...' },
  'prospect.map_unavailable': { en: 'Map unavailable. Add a Google Maps API key to enable real locations.', zu: 'Imephu ayitholakali. Wengeza ukhiye we-Google Maps ukuze uvule izindawo zangempela.' },
  'prospect.map_no_results': { en: 'No properties with location data yet.', zu: 'Azikho izindawo ezinemininingwane yendawo okwamanje.' },
  'prospect.map_interaction_hint': { en: 'Tap a marker to highlight a property.', zu: 'Thepha uphawu ukuze ugqamise ipropathi.' },

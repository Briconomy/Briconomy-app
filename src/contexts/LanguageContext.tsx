...
const translations: Translations = {
  ...
  'terminations.unit': { en: 'Unit', zu: 'Iyunithi' },
  'terminations.reason': { en: 'Reason', zu: 'Isizathu' },
  'terminations.notice_days': { en: 'Notice (Days)', zu: 'Isaziso (Izinsuku)' },
  'terminations.termination_date': { en: 'Termination Date', zu: 'Usuku Lokuqediswa' },
  'terminations.view_details': { en: 'View Details', zu: 'Buka Imininingwane' },
  'terminations.approve': { en: 'Approve', zu: 'Vumela' },
  'terminations.reject': { en: 'Reject', zu: 'Nqaba' },
  ...
  'settlement.subtitle': { en: 'Calculate financial settlements for lease terminations', zu: 'Bala ukuxazulula kwezimali kukuqediswa kwama-lease' },
  'settlement.total_amount': { en: 'Total Settlement Amount', zu: 'Isamba Sokuxazulula Esiphelele' },
  'settlement.average': { en: 'Average Settlement', zu: 'Ukuxazulula Kwesilinganiso' },
  'settlement.refunds_due': { en: 'Refunds Due', zu: 'Ukubuyisela Okudingekayo' },
  'settlement.penalties_charged': { en: 'Penalties Charged', zu: 'Izijeziso Ezikhokhelwe' },
  'settlement.calculations': { en: 'Settlement Calculations', zu: 'Ukubala Kokuxazulula' },
  'settlement.tenant': { en: 'Tenant', zu: 'Umqashi' },
  'settlement.unit': { en: 'Unit', zu: 'Iyunithi' },
  'settlement.security_deposit': { en: 'Security Deposit', zu: 'Idiphozithi Yokuphepha' },
  'settlement.early_termination_fee': { en: 'Early Termination Fee', zu: 'Imali Yokuqediswa Kusenesikhathi' },
  'settlement.prorated_refund': { en: 'Pro-rated Refund', zu: 'Ukubuyisela Okulinganisiwe' },
  'settlement.outstanding_charges': { en: 'Outstanding Charges', zu: 'Izindleko Ezisele' },
  'settlement.final_settlement': { en: 'Final Settlement', zu: 'Ukuxazulula Kokugcina' },
  'settlement.save_calculations': { en: 'Save Calculations', zu: 'Londoloza Ukubala' },
  'settlement.no_terminations': { en: 'There are no terminations available for settlement calculation.', zu: 'Akukho ukuqediswa okutholakalayo kokubala kokuxazulula.' },
  'settlement.refund': { en: 'Refund', zu: 'Ukubuyisela' },
  'settlement.owed': { en: 'Owed', zu: 'Ekweletayo' },
  'settlement.process_settlement': { en: 'Process Settlement', zu: 'Phatha Ukuxazulula' },
  ...
  // Initiate Termination Page
  'initiate_termination.title': { en: 'Initiate Lease Termination', zu: 'Qala Ukuqediswa Kwe-lease' },
  'initiate_termination.subtitle': { en: 'Start a new lease termination process', zu: 'Qala inqubo entsha yokuqediswa kwe-lease' },
  'initiate_termination.select_lease': { en: 'Select Lease', zu: 'Khetha I-lease' },
  'initiate_termination.termination_date': { en: 'Termination Date', zu: 'Usuku Lokuqediswa' },
  'initiate_termination.notice_period': { en: 'Notice Period (Days)', zu: 'Isikhathi Sesaziso (Izinsuku)' },
  'initiate_termination.reason': { en: 'Reason for Termination', zu: 'Isizathu Sokuqediswa' },
  'initiate_termination.additional_notes': { en: 'Additional Notes', zu: 'Amanothi Awengeziwe' },
  'initiate_termination.submit': { en: 'Submit Termination Request', zu: 'Thumela Isicelo Sokuqediswa' },
  'initiate_termination.cancel': { en: 'Cancel', zu: 'Khansela' },
  'initiate_termination.success': { en: 'Termination request initiated successfully', zu: 'Isicelo sokuqediswa siqaliwe ngempumelelo' },
  'initiate_termination.error': { en: 'Failed to initiate termination', zu: 'Kwehlulekile ukuqala ukuqediswa' },

  // Document Generator Page
  'document_generator.title': { en: 'Document Generator', zu: 'Isikhiqizi Samadokhumenti' },
  'document_generator.subtitle': { en: 'Generate termination-related documents', zu: 'Khiqiza amadokhumenti ahlobene nokuqediswa' },
  'document_generator.select_termination': { en: 'Select Termination', zu: 'Khetha Ukuqediswa' },
  'document_generator.document_type': { en: 'Document Type', zu: 'Uhlobo Lwedokhumenti' },
  'document_generator.termination_notice': { en: 'Termination Notice', zu: 'Isaziso Sokuqediswa' },
  'document_generator.settlement_statement': { en: 'Settlement Statement', zu: 'Isitatimende Sokuxazulula' },
  'document_generator.final_inspection': { en: 'Final Inspection Report', zu: 'Umbiko Wokuhlola Kokugcina' },
  'document_generator.release_form': { en: 'Lease Release Form', zu: 'Ifomu Lokukhululwa Kwe-lease' },
  'document_generator.generate': { en: 'Generate Document', zu: 'Khiqiza Idokhumenti' },
  'document_generator.download': { en: 'Download', zu: 'Landa' },
  'document_generator.preview': { en: 'Preview', zu: 'Buka Kuqala' },
  'document_generator.success': { en: 'Document generated successfully', zu: 'Idokhumenti ikhiqizwe ngempumelelo' },
  'document_generator.error': { en: 'Failed to generate document', zu: 'Kwehlulekile ukukhiqiza idokhumenti' },

  // Termination Report Page
  'termination_report.title': { en: 'Termination Analytics & Reports', zu: 'Ukuhlaziya Nokuqediswa Nemibiko' },
  'termination_report.subtitle': { en: 'Comprehensive analysis of lease terminations', zu: 'Ukuhlaziya Okugcwele Kokuqediswa Kwama-lease' },
  'termination_report.overview': { en: 'Termination Overview', zu: 'Ukubuka Kokuqediswa' },
  'termination_report.financial_summary': { en: 'Financial Summary', zu: 'Isifinyezo Sezimali' },
  'termination_report.total_refunds': { en: 'Total Refunds', zu: 'Ukubuyisela Okuphelele' },
  'termination_report.total_penalties': { en: 'Total Penalties', zu: 'Izijeziso Eziphelele' },
  'termination_report.net_settlement': { en: 'Net Settlement', zu: 'Ukuxazulula Okuphelele' },
  'termination_report.refund': { en: 'Refund', zu: 'Ukubuyisela' },
  'termination_report.due': { en: 'Due', zu: 'Kudingeka' },
  'termination_report.top_reasons': { en: 'Top Termination Reasons', zu: 'Izizathu Eziphezulu Zokuqediswa' },
  'termination_report.by_property': { en: 'Terminations by Property', zu: 'Ukuqediswa Ngokwendawo' },
  'termination_report.monthly_trend': { en: 'Monthly Termination Trend', zu: 'Isitayela Sokuqediswa Kuyanyanga' },
  'termination_report.export_report': { en: 'Export Report', zu: 'Thumela Umbiko' },
  'termination_report.export_pdf': { en: 'Export as PDF', zu: 'Thumela njenge-PDF' },
  'termination_report.export_excel': { en: 'Export as Excel', zu: 'Thumela njenge-Excel' },
  'termination_report.export_csv': { en: 'Export as CSV', zu: 'Thumela njenge-CSV' },
  'termination_report.generating': { en: 'Generating report...', zu: 'Kukhiqizwa umbiko...' },
  'termination_report.note': { en: 'Note', zu: 'Qaphela' },
  'termination_report.export_note': { en: 'The exported report will include all data shown in this analytics dashboard.', zu: 'Umbiko othunyelwe uzofaka yonke imininingwane eboniswe kule deshibodi yokuhlaziya.' },
